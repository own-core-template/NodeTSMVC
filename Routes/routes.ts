...
export function RegisterRoutes(app: express.Router) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      XXXXController.prototype.XXXXGetOneTest
    ),

    function XXXXController_XXXXGetOneTest(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.XXXXGetOneTest.apply(
          controller,
  ...
  app.get(
    ...
    function XXXXController_XXXXGetOne(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.XXXXGetOne.apply(
          controller,
          validatedArgs as any
        );
  ...
  app.get(
    ...
    function XXXXController_XXXXGetMany(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.XXXXGetMany.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    function XXXXController_XXXXCreateOne(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.XXXXCreateOne.apply(
          controller,
          validatedArgs as any
        );
  ...
  app.put(
    ...
    function XXXXController_XXXXUpdateOne(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.XXXXUpdateOne.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 201, next);
  ...
  app.delete(
    ...
    function XXXXController_XXXXDeleteOne(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.XXXXDeleteOne.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 201, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      YYYYController.prototype.YYYYGetOneTest
    ),

    function YYYYController_YYYYGetOneTest(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.YYYYGetOneTest.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.get(
    ...
    function YYYYController_YYYYGetOne(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.YYYYGetOne.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function YYYYController_YYYYGetMany(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.YYYYGetMany.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    function YYYYController_YYYYCreateOne(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.YYYYCreateOne.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 201, next);
  ...
  app.put(
    ...
    function YYYYController_YYYYUpdateOne(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.YYYYUpdateOne.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 201, next);
  ...
  app.delete(
    ...
    function YYYYController_YYYYDeleteOne(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.YYYYDeleteOne.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 201, next);
